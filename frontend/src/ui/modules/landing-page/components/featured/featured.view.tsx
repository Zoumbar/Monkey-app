    ...
    >
      <div className="relative w-[130px] h-[130px] rounded-full mb-6 p-10 overflow-hidden">
        <Image
          ...
          className="object-scale-down blur-2xl" //Permet de faire un flou autour de l'image en dessous
        />
        <Image
          fill
          src={feature.imagePath}
          alt={feature.imageAlt}
          className="object-scale-down" //Permet de fit l'image en dessous de la taille du cercle
        />
      </div>
      <Typography
        variant="lead"
  ...
  return (
    <div className="bg-gray-400">
      <Container className="grid grid-cols-12 gap-24 py-24">
        <div className="col-span-7 grid grid-cols-2 gap-7">{featuredList}</div>
