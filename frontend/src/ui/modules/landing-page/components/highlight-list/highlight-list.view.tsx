  ...
  return (
    <Container className="py-24 space-y-10 ">
      <div className="flex justify-center gap-24">
        <div className="w-[532px] h-[350px] relative mt-10">
          <Image fill src="/assets/svg/cake.svg" alt="Illustration de gateau" />
        </div>
        <div className="max-w-md space-y-7">
          <Typography variant="h3" component="h2">
            De novice a développeur en un clin d'oeil !
          </Typography>
